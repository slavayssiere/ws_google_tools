...
public class GConnectToken {
	...
	public boolean token_create(String authCode, String redirectUri) throws Exception {
		...
		GoogleTokenResponse tokenResponse = new GoogleAuthorizationCodeTokenRequest(new NetHttpTransport(),
				JSON_FACTORY, "https://www.googleapis.com/oauth2/v4/token", clientSecrets.getDetails().getClientId(),
	...
	public Credential authorize() throws Exception {
		...
		if (this.credential == null) {
			...
			// authorize
			this.credential = new GoogleCredential.Builder().setTransport(new NetHttpTransport())
